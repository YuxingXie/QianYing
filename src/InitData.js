...
function getSocket() {
    ...
    // socket.on('1',actions.serverBroadcastMessageA);
    return socket;
}
export default {
    forHelp:{
        socket:getSocket(),
        newRoomTitle:'',
        groupChatRooms:[{roomId:'1',rooName:'测试聊天室',chatMessages:['欢迎使用千应救助系统','点击此处 显示/隐藏 聊天文字'],listened:false}],
    ...
    app:{
        ...
        user:{name:'学生妹妹',sex:'f',age:21},

        forHelpTopics:[
            {"roomId":"5","topic":"人民医院门口丢失钱包","lastMessage":{"name":"考生妹妹","message":"怎么办，所有证件都在里面了！"},"photo":"https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2656881601,2258550211&fm=117&gp=0.jpg"},
